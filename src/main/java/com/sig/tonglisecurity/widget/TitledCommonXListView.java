 ...
 * 自定义 ListView
 */
public class TitledCommonXListView extends XListView {
    private View mTitle;

    public TitledCommonXListView(Context context) {
        super(context);
    }

    @SuppressWarnings("deprecation")
    public TitledCommonXListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TitledCommonXListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void updateTitle(String type, String txt03) {
        ...
        if (type != null) {
            ...
            if (type.equals("6")) {
                fund_title_tab02.setText("万分收益");
            } else {
                fund_title_tab02.setText("七日年化");
            }
